  ...
  return (
    <>
      <motion.footer
        ...
        className="relative z-10 bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] footer"
        style={{ backgroundImage: "url('./ftbg.jpg')" }}
      >
              ...
              <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                <div className="mb-10 w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">
                    &copy; 2023 Powered by Comfort Techno Service
                  </p>
                </div>
              </div>
            </div>
